...
[Download SI-Coder Skill v0.8.13 (`sc.zip`)](https://github.com/rahmanef63/si-coder-agent/releases/download/v0.8.13/sc.zip)

For inspection, the canonical source is:

- [sc skill directory](https://github.com/rahmanef63/si-coder-agent/tree/v0.8.13/skills/sc)
...
SI-Coder also publishes an optional [`sc.skill`](https://github.com/rahmanef63/si-coder-agent/releases/download/v0.8.13/sc.skill) archive for clients that explicitly accept `.skill`; OpenAI's current ChatGPT Help Center does not require that extension, so it is not the default ChatGPT link.
