...
- [skills/sc directory](https://github.com/rahmanef63/si-coder-agent/tree/v0.9.7/skills/sc)
...
- [ZIP package](https://github.com/rahmanef63/si-coder-agent/releases/download/v0.9.7/sc.zip)
