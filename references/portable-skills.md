...
## Stable links for v0.8.5

- Source directory: `https://github.com/rahmanef63/si-coder-agent/tree/v0.8.5/skills/sc`
- Raw entry point: `https://raw.githubusercontent.com/rahmanef63/si-coder-agent/v0.8.5/skills/sc/SKILL.md`
- ZIP upload package: `https://github.com/rahmanef63/si-coder-agent/releases/download/v0.8.5/sc.zip`
