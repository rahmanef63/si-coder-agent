...
- [skills/sc directory](https://github.com/rahmanef63/si-coder-agent/tree/v0.8.13/skills/sc)
- [raw `SKILL.md`](https://raw.githubusercontent.com/rahmanef63/si-coder-agent/v0.8.13/skills/sc/SKILL.md)
...
- [ZIP package](https://github.com/rahmanef63/si-coder-agent/releases/download/v0.8.13/sc.zip)
- [optional `.skill` archive](https://github.com/rahmanef63/si-coder-agent/releases/download/v0.8.13/sc.skill)
