...
function listManagedSkills(options = {}) {
  ...
  for (const rootInfo of managedRoots(options)) {
    ...
    for (const entry of entries) {
      ...
      // install.sh links bundled SC skills into ~/.mso/skills. The bundled catalog
