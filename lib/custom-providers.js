...
// title/blurb, env-key names, and simple validation hints. Secret VALUES continue to live
// in the existing profile/bashrc credential store, so there is exactly one credential path.
const fs = require('fs');
