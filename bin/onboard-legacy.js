#!/usr/bin/env node
// bin/onboard-legacy.js — DEPRECATED shell-export wizard retained only for explicit legacy automation.
...
async function main() {
  ...
  console.log('\n⚠️ legacy SI-Coder shell-export onboarding\n');
  console.log('   Fresh installs should use: sc setup');
  console.log('   This compatibility path can write managed exports to ~/.bashrc.\n');
