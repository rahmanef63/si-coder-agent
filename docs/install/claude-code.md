...
- [skills/sc directory](https://github.com/rahmanef63/si-coder-agent/tree/v0.8.4/skills/sc)
- [raw skills/sc/SKILL.md](https://raw.githubusercontent.com/rahmanef63/si-coder-agent/v0.8.4/skills/sc/SKILL.md)
...
When a provider credential is genuinely required locally, SI-Coder gives the official creation page and a secure `sc secret set ...` handoff. Do not paste raw provider keys into chat.
