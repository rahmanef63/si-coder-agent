...
## Current release links — v0.9.6

- Source directory: `https://github.com/rahmanef63/si-coder-agent/tree/v0.9.6/skills/sc`
- Raw entry point: `https://raw.githubusercontent.com/rahmanef63/si-coder-agent/v0.9.6/skills/sc/SKILL.md`
- ZIP upload package: `https://github.com/rahmanef63/si-coder-agent/releases/download/v0.9.6/sc.zip`
- Optional `.skill` archive: `https://github.com/rahmanef63/si-coder-agent/releases/download/v0.9.6/sc.skill`
...
Treat a pushed tag, a GitHub Release, and an npm publication as separate states. Before presenting a public download as usable, verify the destination without maintainer authentication. The v0.9.6 release workflow fails closed if GitHub/raw tagged source is not publicly reachable and can be rerun for the same existing tag after visibility is restored.
