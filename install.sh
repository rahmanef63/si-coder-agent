...
echo "   /sc-all          → end-to-end deploy (--target dokploy|hybrid|vercel)"
echo "   /sc-help         → quick-reference card for the whole sc-* bundle"
...
echo "   /sc-provider     → provider CRUD + secret-safe agent control plane"
