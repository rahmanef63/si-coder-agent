...
- [Canonical `sc` skill directory](https://github.com/rahmanef63/si-coder-agent/tree/v0.9.7/skills/sc)
- [View raw `SKILL.md`](https://raw.githubusercontent.com/rahmanef63/si-coder-agent/v0.9.7/skills/sc/SKILL.md)
- [Download upload-ready `sc.zip`](https://github.com/rahmanef63/si-coder-agent/releases/download/v0.9.7/sc.zip)
- [Download optional `sc.skill`](https://github.com/rahmanef63/si-coder-agent/releases/download/v0.9.7/sc.skill)
