...
use_when: "Use only when maintaining or implementing the unfinished Clerk automation itself."
do_not_use_when: "Do not route normal user-facing Clerk/auth provisioning tasks here; the automation is not implemented yet. Keep credential preparation in sc-provider and explain the current limitation."
required_tools: []
